                                ...
                                <div className="flex-grow flex flex-col justify-center items-center gap-2">
                                    ...
                                    <div className="flex items-center space-x-4 mt-2">
                                        <button
                                            ...
                                            className="bg-yellow-500 text-white w-8 h-8 flex items-center justify-center rounded-lg hover:bg-red-600"
                                        >
                                            -
                                        </button>
                                        ...
                                        <button
                                            onClick={() => handleQuantityChange(product.id, 1)}
                                            className="bg-pink-400 text-white w-8 h-8 flex items-center justify-center rounded-lg hover:bg-green-600"
                                        >
                                            +
                                        </button>
                                    </div>
